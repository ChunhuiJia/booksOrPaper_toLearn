%  Figure 4.11      Feedback Control of Dynamic Systems, 7e
%                   Franklin, Powell, Emami
% Figure 4.11   PID control of motor speed
% Example 4.5
...
plot(t,y1w,t,y2w,t,y3w,'LineWidth',2);
xlabel('Time (msec)');
ylabel('Amplitude');
title('Fig. 4.11(a): Response of P, PI, and PID control to a disturbance step')
gtext('P')
gtext('PI')
gtext('PID')
grid;
...
xlabel('Time (msec)');
ylabel('Amplitude');
title('Fig. 4.11(b): Response of P, PI, and PID control to a reference step')
gtext('P')
gtext('PI')
gtext('PID')
grid;